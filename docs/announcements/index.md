...
<div class="blog-header">
  <h1>Announcements</h1>
  <p class="blog-subtitle">Official updates from the RedTeam. Check here for the latest news, event notices, and important messages. It's where we post what's new, what's coming, and what everyone should know.</p>
</div>
...
<div class="blog-grid">
  ...
  <article class="blog-card">
    <div class="blog-card-image">
      <img alt="Auto Browser Sniffer v4" src="https://github.com/user-attachments/assets/9335e859-90b8-4277-b95f-eabc55e3a041" />
    </div>
    <div class="blog-card-content">
  ...
  <article class="blog-card">
    ...
    <div class="blog-card-content">
      ...
      <p class="blog-card-excerpt">How Dynamic TAO and the Alpha token reshape RedTeam's decentralized cybersecurity incentives.</p>
    </div>
  </article>
  ...
  <article class="blog-card">
    ...
    <div class="blog-card-content">
      ...
      <p class="blog-card-excerpt">A new wave of bot detection challenges has been released to Subnet 61, advancing our security testing suite.</p>
    </div>
  </article>
