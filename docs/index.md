...
<div class="blog-grid">
    <a href="blog/posts/blog.linking_logic/" class="blog-card-link">
    ...
    <a href="blog/posts/dfp2-status-update/" class="blog-card-link">
        <article class="blog-card">
            <div class="blog-card-image">
  ...
  <a href="blog/posts/an.structural-internal-services/" class="blog-card-link">
    <article class="blog-card">
        <div class="blog-card-image">
        ...
        <div class="blog-card-content">
            ...
            <h2>
                Submission Validation & Internal Services
            </h2>
            <p class="blog-card-excerpt">
                Providing fairness by new validation and comparison logic which will be fully hidden inside of internal services
            </p>
        </div>
    </article>
  </a>
